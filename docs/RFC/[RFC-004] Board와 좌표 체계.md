...
## Section
<!-- TODO: ADR-005 작성 권장 - Section 개념 도입 이유 (무한 맵에서 Tile 관리 효율성 등의 논의 사항) -->

`Section`은 `Boardhandler` scope에 국한된 개념입니다.

일정한 크기(100)의 높이와 넓이를 가진 `Tile`집합입니다.
...
## 범위 좌표 접근
범위에 대해 좌표로 접근할 경우 좌상부터 우하까지의 좌표를 명시하여 범위로 접근합니다.
